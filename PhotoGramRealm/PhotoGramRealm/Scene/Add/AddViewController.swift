...
class AddViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad() //안하는 경우 생기는 문제 화면이 버벅거리다가 괜찮아진다..등
    ...
    @objc func saveButtonClicked() {
        ...
        //nil일 때는 저장이 안되고 url이 있으면 저장이 된다.
        ...
        if userImageView.image != nil {
            saveImageToDocument(fileName: "han_\(task._id).jpg", image: userImageView.image!)
        }
